...
import shutil
import requests
import functions_framework  # Import the functions_framework library

app = Flask(__name__)
model = YOLO('E:\Machine Learning\Object Detection\App IV\Models\MODEL3200.pt')
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "E:/Machine Learning/Object Detection/App IV/backend/googlekey.json"
...
def main(request):
    ...
    def webhook():
        ...
        if bike_number:
            ...
            ngrok_url = 'https://odis-bk3mssg6hq-ts.a.run.app'
            with requests.post(ngrok_url + '/filter_images', json=data, timeout=50) as response:
